...
function GameMode:_InitGameMode()
	...
	-- Should we use custom hero XP bounties, or the default Dota numbers?
	...
	SetTeamCustomHealthbarColor(DOTA_TEAM_GOODGUYS, 100, 255, 100)
	SetTeamCustomHealthbarColor(DOTA_TEAM_BADGUYS, 255, 90, 90)
...
function GameMode:_CaptureGameMode()
	if mode == nil then
		...
		mode:SetCameraDistanceOverride(2600)
