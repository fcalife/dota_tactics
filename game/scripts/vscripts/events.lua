...
-- A hero spawned in the game for the first time
function GameMode:OnHeroInGame(hero)
	print(hero:GetUnitName() .. " spawned in game for the first time.")

	-- Modifier to hide heroes from the game
	hero:AddNewModifier(hero, nil, "modifier_tactics_hidden_hero", {})
end
